...
export default function StatCompareIcon(props: StatCompareIconProps) {
  ...
  return (
    <div
      className={cn(
        'rounded-md p-0.5 w-fit border h-fit',
        (props.reverse === undefined && props.thisStat > props.thatStat) ||
          (props.reverse && props.thisStat < props.thatStat)
          ? 'bg-green-400/90 text-green-700 dark:border-green-700 border-green-500'
          : (props.reverse === undefined && props.thisStat < props.thatStat) ||
              (props.reverse && props.thisStat > props.thatStat)
            ? 'bg-red-400/90 text-red-700 dark:border-red-700 border-red-500'
            : 'bg-neutral-200/90 dark:bg-neutral-800 text-neutral-400 dark:text-neutral-600 border-neutral-300 dark:border-neutral-700'
      )}
    >
